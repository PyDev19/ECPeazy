<script lang="ts">
    ...
    function next() {
        if (step < 1) {
            const inputs = [first_name_input, last_name_input, school_input, age_input, graduation_year_input];
            let has_error = false;
            show_error = false;
    ...
    function submit() {
        const inputs = [username_input, email_input, password_input, confirm_password_input];
        let has_error = false;
        show_error = false;
